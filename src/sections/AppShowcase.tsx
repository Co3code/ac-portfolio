            ...
            <div>
              ...
              >
                ...
                <h3 className="text-4xl md:text-6xl font-display font-bold mb-6">
                  Experience my <span className="text-gradient">Latest App</span>
                </h3>
                <p className="text-lg text-zinc-400 mb-8 leading-relaxed">
                  I've built a fully functional Android application that solves daily productivity challenges. 
                  Download the APK directly to your device and try it out!
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500">Verified APK build</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-white">Fast Performance</h4>
                      <p className="text-xs text-zinc-500">Optimized for Android</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative flex justify-center lg:justify-end">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-6">
                  ...
                  <p className="text-white font-bold text-xl">Aura Mobile</p>
                  <p className="text-white/60 text-xs">v1.0.4 Stable</p>
                </div>
              </motion.div>
